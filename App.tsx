      ...
      <section id="lawsuits">
        ...
        <div className="space-y-6">
          {LAWSUITS_DATA.map((lawsuit: Lawsuit) => (
            <div
              key={lawsuit.id}
              className="bg-white p-6 rounded-lg shadow-md border border-slate-200 hover:shadow-lg transition-shadow duration-300 border-l-4 border-amber-300"
            >
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen font-sans text-slate-800">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12">{renderPage()}</main>
      <Footer />
      <Chatbot />
    </div>
  );
